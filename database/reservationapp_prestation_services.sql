...
CREATE TABLE `prestation_services` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_order_prestation_idx` (`prestation`),
  KEY `fk_order_service_idx` (`service`),
  CONSTRAINT `fk_order_prestation` FOREIGN KEY (`prestation`) REFERENCES `prestation` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_order_service` FOREIGN KEY (`service`) REFERENCES `service` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
