...
export function Header(props: ViewProps) {
  ...
  return <View style={[{ backgroundColor: Colors[selectedTheme].text, flexDirection: "row", alignItems: "center" }, style]} {...otherProps}>
    <Image style={{ width: 50, height: 50, margin: 20 }}
      source={require("../assets/images/cauldron.png")} />
    <Text style={{ color: Colors[selectedTheme].background, textAlign: "center", flex: 1, fontSize: 24, fontWeight: "500", fontFamily: "ravie" }}>Wizz Fortune Telling</Text>
